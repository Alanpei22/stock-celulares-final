...
ok(/2 ítems/.test(html), 'contador incluye la reparación', html.match(/\d+ ítems?/));
ok(/\$45\.000|45000/.test(html.replace(/\s/g,'')), 'total 45.000', html.match(/cart-total-row[\s\S]*?<\/div>/));
