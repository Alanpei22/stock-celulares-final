...
// Variantes de precio para la tarjeta del equipo (transferencia + cuotas)
function buildPriceChips(precio) {
  ...
  return `<div class="card-price-variants">
    <span class="cpv"><span class="cpv-lbl">🏦 Transf.</span> <span class="cpv-val">${f(transfer)}</span></span>
    <span class="cpv"><span class="cpv-lbl">3 cuotas</span> <span class="cpv-val">${f(c3 / 3)}<small>/c</small></span></span>
    <span class="cpv"><span class="cpv-lbl">6 cuotas</span> <span class="cpv-val">${f(c6 / 6)}<small>/c</small></span></span>
  </div>`;
}
